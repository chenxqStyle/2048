...
var game={
  ...
  init:function(){//生成gridPanel中的所有div
	...
	if(!navigator.cookieEnable){
		alert("您的浏览器已禁用cookie,最高的分功能无法使用");
	}
...
window.onload=function() {
  document.querySelector("#login-form input[type='button']").onclick=function(){
    game.RN=document.getElementById("row").value;
    //console.log(game.RN);
    game.CN=document.getElementById("col").value;
    di=document.querySelector(".modal").style.display="none";
    game.start();
  }
}